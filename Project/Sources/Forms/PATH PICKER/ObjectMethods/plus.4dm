  ...
  // ----------------------------------------------------
  // Declarations
C_LONGINT:C283($Lon_;$Lon_bottom;$Lon_formEvent;$Lon_i;$Lon_left;$Lon_platform)
...
Case of 
	...
	: ($Lon_formEvent=On Clicked:K2:4)
		...
		If (Count menu items:C405($Mnu_popup)>0)
			...
			CONVERT COORDINATES:C1365($Lon_left;$Lon_bottom;1;2)
			
			$Txt_action:=Dynamic pop up menu:C1006($Mnu_popup;"";$Lon_left;$Lon_bottom-5)
